...
# 预配置参数
config_path='./config/yolov3-coco.cfg'
weights_path='./config/yolov3-coco.weights'
cuda = True
# 加载类别标签文件
LABELS = config.names
nclass = len(LABELS)
...
if __name__ == '__main__':
    result = yolo_detect(cv2.imread("img/val2017/000000033114.jpg"))
